...
interface UnderscoreStatic {
     ...
     **/
    each<T>(list:_.List<T>, iterator:_.ListIterator<T, void>, context?:any): void;
     ...
     * @param context 'this' object in `iterator`, optional.
     **/
    each<T>(object:_.Dictionary<T>, iterator:_.ObjectIterator<T, void>, context?:any): void;

    /**
     * @see _.each
     **/
    forEach<T>(list:_.List<T>, iterator:_.ListIterator<T, void >, context?:any): void;

    /**
     * @see _.each
     **/
    forEach<T>(object:_.Dictionary<T>, iterator:_.ObjectIterator<T, void >, context?:any): void;
     ...
     * @see _.map
     **/
    collect<T, TResult>(list:_.List<T>, iterator:_.ListIterator<T, TResult>, context?:any): TResult[];
     ...
     **/
    find<T>(list:_.Collection<T>, iterator:_.ListIterator<T, boolean>, context?:any): T;

    /**
     * @see _.find
     **/
    detect<T>(list:_.Collection<T>, iterator:_.ListIterator<T, boolean>, context?:any): T;
     ...
     **/
    filter<T>(list:_.Collection<T>, iterator:_.ListIterator<T, boolean>, context?:any): T[];

    /**
     * @see _.filter
     **/
    select<T>(list:_.Collection<T>, iterator:_.ListIterator<T, boolean>, context?:any): T[];
     ...
     **/
    where<T, U extends {
    }>(list:_.Collection<T>, properties:U): T[];
     ...
     **/
    reject<T>(list:_.Collection<T>, iterator:_.ListIterator<T, boolean>, context?:any): T[];
     ...
     **/
    every<T>(list:_.Collection<T>, iterator?:_.ListIterator<T, boolean>, context?:any): boolean;

    /**
     * @see _.all
     **/
    all<T>(list:_.Collection<T>, iterator?:_.ListIterator<T, boolean>, context?:any): boolean;
     ...
     **/
    any<T>(list:_.Collection<T>, iterator?:_.ListIterator<T, boolean>, context?:any): boolean;

    /**
     * @see _.any
     **/
    some<T>(list:_.Collection<T>, iterator?:_.ListIterator<T, boolean>, context?:any): boolean;
     ...
     **/
    contains<T>(list:_.Collection<T>, value:T): boolean;
     ...
     **/
    invoke<T extends {
    }>(list:_.Collection<T>, methodName:string, ...arguments:any[]): any;
     ...
     **/
    pluck<T extends {
    }>(list:_.Collection<T>, propertyName:string): any[];
     ...
     **/
    min<T>(list:_.Collection<T>, iterator?:_.ListIterator<T, any>, context?:any): T;
     ...
     **/
    countBy<T>(list:_.Collection<T>, iterator?:_.ListIterator<T, any>, context?:any): _.Dictionary<number[]>;

    /**
     * @see _.countBy
     * @param iterator Function name
     **/
    countBy<T>(list:_.Collection<T>, iterator:string, context?:any): _.Dictionary<number[]>;
    ...
    }>(keys:_.List<string>, values:_.List<any>): TResult;
     ...
     **/
    object<TResult extends {
    }>(...keyValuePairs:any[][]): TResult;

    /**
     * @see _.object
     **/
    object<TResult extends {
    }>(list:_.List<any>, values?:any): TResult;
     ...
     **/
    sortedIndex<T, TSort>(list:_.List<T>, value:T, iterator?:(x:T) => TSort, context?:any): number;
     ...
     **/
    throttle(func:any, wait:number, options?:_.ThrottleSettings): Function;
