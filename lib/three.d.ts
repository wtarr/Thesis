...
declare module THREE {
    ...
    export interface IVectorCustomisable {
    ...
    export class Texture {
        constructor(image:HTMLImageElement, mapping?:Mapping, wrapS?:Wrapping, wrapT?:Wrapping, magFilter?:TextureFilter, minFilter?:TextureFilter, format?:PixelFormat, type?:TextureDataType, anisotropy?:number);
    ...
    export var FontUtils:{
        ...
        generateShapes(text:string, parameters?:{ size?: number; curveSegments?: number; font?: string; weight?: string; style?: string;
        }): Shape[];
        Triangulate: {
    ...
    export var ImageUtils:{
        ...
        parseDDS(buffer:ArrayBuffer, loadMipmaps:boolean): { mipmaps: { data: Uint8Array; width: number; height: number;
        }[]; width: number; height: number; format: number; mipmapCount: number;
        };
    ...
    export class ExtrudeGeometry extends Geometry {
        ...
        static WorldUVGenerator:{
            ...
            generateSideWallUV(geometry:Geometry, extrudedShape:Shape, wallContour:Object, extrudeOptions:Object, indexA:number, indexB:number, indexC:number, indexD:number, stepIndex:number, stepsLength:number, contourIndex1:number, contourIndex2:number): Vector2[];
        };
    }
