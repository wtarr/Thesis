...
QUnit.test("Test Voxel center positions are being correctly calculated for the world specified ", function () {
    ...
    ok(world[0][0].centerPosition.x === -75 && world[0][0].centerPosition.y === -75 && world[0][0].centerPosition.z === -75, "Position of first voxel center is correct");
});
...
QUnit.test("Remove first instance THREE.Vector3 match from array", function () {
    ...
    ok(array[0].equals(new THREE.Vector3(1, 2, 3)) && array[1].equals(new THREE.Vector3(1, 2, 3)) && array[2].equals(new THREE.Vector3(1, 3, 4)), "All present and accounted for");
});
